...
{
    public class SegmentProductCategoryService : ServiceMapper<SegmentProductCategory>, ISegmentProductCategoryService
    {
        public SegmentProductCategoryService(IUnitOfWork unitOfWork, ITypeAdapter typeAdapter, ISegmentProductCategoryRepository repository)
