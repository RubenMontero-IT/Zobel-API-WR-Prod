...
namespace Zobel.WealthReport.Infrastructure.Data.Migrations.ProjectManagement
{
    ...
    [Migration("20200723020101_AddOrganizationToReportTemplatePermisssion")]
    partial class AddOrganizationToReportTemplatePermisssion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zobel.Reports.Domain.Entities.ReportManager.TemplateSettings", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Zobel.WealthReport.Domain.Entities.ConnectionByOrganization", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ORGID")
            ...
            modelBuilder.Entity("Zobel.WealthReport.Domain.Entities.SignableStatement", b =>
                {
                    b.Property<string>("Id")
            ...
            modelBuilder.Entity("Zobel.WealthReport.Domain.Entities.StatementCategory", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnName("StatementCategoryID")
                        .HasMaxLength(100);
            ...
            modelBuilder.Entity("Zobel.Reports.Domain.Entities.ReportManager.TemplateSettings", b =>
                {
                    ...
                    b.HasOne("Zobel.Common.Domain.Entities.Admin.UserRoleOrg", "UserRoleOrg")
                        .WithMany()
            ...
            modelBuilder.Entity("Zobel.WealthReport.Domain.Entities.SignableStatement", b =>
                {
                    ...
                    b.HasOne("Zobel.Common.Domain.Entities.Admin.User", "SignedBy")
                        .WithMany()
                        .HasForeignKey("SignedById")
                        .HasConstraintName("FK_SignableStatement_User");

                    b.HasOne("Zobel.WealthReport.Domain.Entities.StatementCategory", "StatementCategory")
                        .WithMany()
