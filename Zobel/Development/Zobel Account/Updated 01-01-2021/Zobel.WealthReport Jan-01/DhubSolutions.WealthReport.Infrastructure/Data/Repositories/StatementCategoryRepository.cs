...
{
    public class StatementCategoryRepository : Repository<StatementCategory>, IStatementCategoryRepository
    {
        public StatementCategoryRepository(ProjectManagementDbContext dbContext, IUnitOfWork unitOfWork)
